...
/*
Author: Marc Lee
Description: Create my dog only using OpenGL components
*/
...
class vtk441MapperPart3 : public vtk441Mapper
{
 public:
   ...
   virtual void RenderPiece(vtkRenderer *ren, vtkActor *act)
   {
       ...
       glPushMatrix();
       Brown();
       glTranslatef(-5.3, 0, -2);
       glRotatef(35.0, 0, 1, 0);
       glScalef(1.5, 1.5, 2.7);
       DrawCylinder();
       glPopMatrix();
